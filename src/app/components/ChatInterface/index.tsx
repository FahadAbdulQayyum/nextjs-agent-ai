      ...
      <div className="flex-none bg-white border-t border-gray-200 p-4">
        <form onSubmit={handleSubmit} className="flex gap-2">
          <input
            ...
            className="flex-1 p-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-commonColor"
            disabled={isLoading}
          />
          <button
            type="submit"
            ...
            className="px-6 py-3 bg-commonColor text-white rounded-lg hover:bg-commonColor focus:outline-none focus:ring-2 focus:ring-commonColor disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
          >
            Chat
          </button>
        </form>
